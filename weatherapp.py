...
def data_get():
    city=city_name.get()
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=a4de4db759224962b905c36f4a2994a1").json()
...
name_label=Label(win,text="Weather App",font=("Times New Roman",20,"bold"))
